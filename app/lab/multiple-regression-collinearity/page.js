        ...
        <div className="lab-header-action-stack">
          ...
          <button
            ...
            onClick={() =>
              downloadCsv(
                mode === "multiple"
                  ? "multiple-regression-collinearity-jamovi.csv"
                  : "collinearity-jamovi.csv",
                mode === "multiple" ? scenes.multiple.rows : scenes.collinearity.rows,
                mode === "multiple"
                  ? [
                  ...
                  : [
                      { label: "study_hours", value: (row) => row.x1.toFixed(6) },
                      { label: "review_hours", value: (row) => row.x2.toFixed(6) },
                      { label: "score", value: (row) => row.y.toFixed(6) },
                    ],
              )
            }
